...
const originalData = [
	{ architect: 'Álvaro Siza', continent: 'Africa', country: 'France', city: 'Vienna', style: 'Dark Age Europe', purpose: 'sport'},
	{ architect: 'Antoine Predock', continent:'US', country:'France', city:'Vienna', style:'Dark Age Europe', purpose:'sport'},
	{ architect: 'Ben van Berkel', continent:'NL', country:'France', city:'Vienna', style:'Dark Age Europe', purpose:'sport'},
	{ architect: 'Bernard Tschumi', continent:'CH', country:'Croatia', city:'Vienna', style:'Dark Age Europe', purpose:'sport'}
]


const Architects = () => {
	const [ data, setData ] = React.useState(originalData);
	const [ searchValues, setSearchValues ] = React.useState({ architect: '', continent: '', country: '', city: '', style: '', purpose: ''});
	...
	const handleApply = () => {
		const newData = originalData.filter(item => {
			if ((searchValues.architect.toLocaleLowerCase() === item.architect.toLocaleLowerCase() || searchValues.architect === '')
				&& (searchValues.continent.toLocaleLowerCase() === item.continent.toLocaleLowerCase() || searchValues.continent === '')
				&& (searchValues.country.toLocaleLowerCase() === item.country.toLocaleLowerCase() || searchValues.country === '')
				&& (searchValues.city.toLocaleLowerCase() === item.city.toLocaleLowerCase() || searchValues.city === '')
				&& (searchValues.style.toLocaleLowerCase() === item.style.toLocaleLowerCase() || searchValues.style === '')
