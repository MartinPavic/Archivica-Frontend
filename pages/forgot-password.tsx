	...
	return (
        <ThemeProvider theme={theme}>
            ...
            <Container maxWidth="xs">
                <CssBaseline />
				<SnackbarWrapper 
					show={!!forgotPasswordRequest.data || !!forgotPasswordRequest.error} 
					success={!!forgotPasswordRequest.data} 
					message={forgotPasswordRequest.data || forgotPasswordRequest.error}>
					<Box display="flex" flexDirection="column" alignItems="center">
						...
						<form onSubmit={handleSubmit(onSubmit)} noValidate autoComplete="email">
							...
							<Button type="submit" style={{backgroundColor: "#1976d2", color: "white"}} fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} disabled={!isValid && !forgotPasswordRequest.loading}>
