...
const Blog = () => {
    return (
        <div className={style.blog}>
            ...
            <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates eius natus qui magni quisquam
                veritatis placeat officia iste repellendus, mollitia exercitationem quos ipsa provident, aspernatur
                laboriosam, hic eos quaerat et?
            </p>
            <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates eius natus qui magni quisquam
                veritatis placeat officia iste repellendus, mollitia exercitationem quos ipsa provident, aspernatur
            ...
            <div className={style.blog_comments}>
                <Box sx={{ display: "flex", alignItems: "flex-start", marginBottom: "15px" }}>
                    ...
                    <div className={style.blog_comments_data}>
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit labore porro tempora
                            eius facere, nulla quidem sit ipsum necessitatibus beatae? Maiores rerum ullam cupiditate
                            tempora quidem sit vitae debitis tenetur.
                        </p>
                    </div>
                </Box>
                <Box sx={{ display: "flex", alignItems: "flex-start", marginBottom: "15px" }}>
