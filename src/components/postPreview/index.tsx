...
const PostPreview = (props: any) => {
    ...
    return (
        <>
            {showPost && (
                <PostDetails image="/assets/images/temp/tempPlace.jpg" onClose={() => setShowPost(!showPost)} />
            )}
            <Card className="">
                ...
                {props.image && (
                    <div className="flex relative justify-center items-end overflow-hidden w-full h-48 cursor-pointer" onClick={() => setShowPost(!showPost)}>
                    ...
                    <div className={style.postPreview_actions}>
                        <Button>
                            <AiOutlineLike
                                color="#676767"
                                fontSize={25}
                                className={style.postPreview_actions_likeIcon}
                            />
                            Like
                        </Button>
                        <Button onClick={() => setShowCommentSection(!showCommentSection)}>
                            <GoComment
                                color="#676767"
                                fontSize={25}
                                className={style.postPreview_actions_commentIcon}
                            />
                            Comment
                        </Button>
                    </div>
